export const collections: Collection[] = [
  ...
  },
  {
    ...
    slug: 'kitchen-dining',
    description:
      '<p>The hub of every home is the kitchen. And for us, a kitchen is the perfect place to create a visual feast with a variety of modern utensils, decorations, and table sets. Find everything you need for a mid-century modern kitchen from bowls and baking dishes to modern dining table sets, cookware, and professional-grade chef’s knives</p><p>\nOutfit your kitchen – the heart of the home – with modern kitchen accessories including spice racks, world-class knives, placemats, bakeware, and so much more. Shop our collection of kitchen accessories to make your kitchen mealtime-time ready.</p>',
    thumbnail:
      'cdn.shopify.com/s/files/1/1087/6904/collections/kitchen-dining-715140_2000x.png?v=1678748562',
    featureProductId: null,
    createdAt: '2023-06-06T04:59:05.223Z',
  },
]
